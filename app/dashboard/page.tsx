  ...
  return (
    <>
      <main className="min-h-screen w-full flex flex-col items-center justify-center bg-[#02503B] px-4 py-10" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        <div className="text-lg text-[#B04F17] mb-8 font-black">{userData?.position && `${userData.position} at `}{userData?.school}</div>
      ...
      <div className="fixed bottom-0 left-0 w-full z-50 flex justify-center pb-6">
        <form action={signOutAction} method="POST">
          <button
            type="submit"
            className="underline font-black text-[#FFF7E6] bg-transparent border-none shadow-none px-0 py-0 text-lg hover:text-[#B04F17] transition-colors"
